...
import com.mt.mybatislog.action.*;
...
public class MyBatisLogManager implements Disposable {
    ...
    private volatile String parametersType;
    private volatile boolean isMyBatis;
    ...
    private MyBatisLogManager(@NotNull Project project) {
        ...
        this.parametersType = propertiesComponent.getValue(PARAMETERS_TYPE_KEY, "Types: ");
        this.isMyBatis = propertiesComponent.getBoolean(IsMyBatis);
