...
import static com.mt.mybatislog.MyBatisLogConsoleFilter.*;
...
public class SettingsDialogWrapper extends DialogWrapper {
    ...
    private JTextField txtParametersTypes;
    ...
    private JRadioButton mybatisRadioButton;
    private JRadioButton ibatisRadioButton;
    ...
    protected JComponent createCenterPanel() {
        ...
        txtParametersTypes.setText(propertiesComponent.getValue(PARAMETERS_TYPE_KEY, "Types:"));
        mybatisRadioButton.setSelected(propertiesComponent.getBoolean(IsMyBatis));
        ibatisRadioButton.setSelected(!propertiesComponent.getBoolean(IsMyBatis));
    ...
    private void saveProperties() {
        ...
        final String parametersTypes = getParametersTypes();
        final String keywords = getKeywords();
        final boolean isMyBatis = getIsMybatis();


        propertiesComponent.setValue(PREPARING_KEY, getPreparing());
        propertiesComponent.setValue(PARAMETERS_KEY, getParameters());
        propertiesComponent.setValue(PARAMETERS_TYPE_KEY, getParametersTypes());
        propertiesComponent.setValue(IsMyBatis, getIsMybatis());
        ...
        manager.setParametersType(parametersTypes);
        manager.resetKeywords(keywords);
        manager.setMyBatis(isMyBatis);
    }
    ...
    public String getParametersTypes() {
        return StringUtils.defaultIfBlank(txtParametersTypes.getText(), "Types:");
    }

    public boolean getIsMybatis() {
        return mybatisRadioButton.isSelected();
    }
    public boolean getIsIbatis() {
        return ibatisRadioButton.isSelected();
    }
}
